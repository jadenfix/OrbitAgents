...
const AuthProvider = lazy(() => 
  import('@/contexts/AuthContext').then(module => ({ default: module.AuthProvider })).catch(() => ({ default: () => <SimpleLandingPage /> }))
)

const Login = lazy(() => 
  import('@/pages/Login').catch(() => ({ default: SimpleLandingPage }))
)

const SplitPaneLayout = lazy(() => 
  import('@/components/Layout/SplitPaneLayout').catch(() => ({ default: SimpleLandingPage }))
)
